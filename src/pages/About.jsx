    ...
    <div className="bg-gray-900 text-white min-h-screen p-10 ">
     ...
     <div>
        <div className="mb-16">
            ...
            <li><span className="font-bold">First Name:</span> Majharul </li>
                <li><span className="font-bold">Last Name:</span> Islam</li>
                ...
                <li><span className="font-bold">Email:</span> majhar13579@gmai.com</li>
            </ul>
          </div>
          <div className="mb-10">
              <h2 className="text-4xl font-semibold mb-6 text-center ">Personal Info</h2>
      ...
      {stats.map((stat, index) => (
        <div key={index} className="text-center text-white p-7 shadow-orange-400 rounded-md bg-black ">
          <h2 className="text-5xl font-bold text-yellow-400 text-start">{stat.value}</h2>
